<template>
  <article v-if="jobSeek">
    <b-link
      ...
      :to="`/stellengesuche/${jobSeek._id}`"
      target="_self"
      :disabled="linkDisabled"
    >
      <div class="card-body p-0 mb-2">
        <div class="row">
          <div class="col-3 col-md-2 col-xl-1 order-2 order-md-1">
            <b-img-lazy
          ...
          <div class="col-9 col-md-10 col-xl-11 order-1 order-md-2 pr-0">
            <h3
              class="h4 bold mb-1"
      ...
      <div class="row">
        <div class="col-0 col-md-2 col-xl-1"></div>
            ...
            >
              ...
              <span>
                ...
                <span v-if="jobSeek.training"
                  ><span v-if="jobSeek.fullTime">&nbsp;| </span>Ausbildung</span
                >
