        ...
        <b-row no-gutters>
            <b-col md="3">
                <b-img
                    ...
                    src="@/assets/profiling_monochromatic.svg"
                    alt="Tipps für einen effizienten Bewerbungsprozess für MFAs / Arzthelfer*innen"
                ></b-img>
            </b-col>
            <b-col md="9">
                <b-card-body
                ...
                >
                    ...
                    <b-button
                        to="/article/tipps-fuer-einen-effizienten-bewerbungsprozess"
                        variant="primary"
