<template>
  <BCard no-body class="overflow-hidden shadow1 p-3" align="center">
    ...
    >
      <h3 class="h2 bold">Unser Online Fortbildungskalender!</h3>
      <p>
      ...
      <b-button to="/karriere/fortbildungskalender" variant="secondary"
        >Zum Fortbildungskalender</b-button
      >
    </BCardBody>
  </BCard>
</template>
...
<script>
  ...
  export default {
    name: "TrainingCalendarLargeBanner"
  };
</script>
