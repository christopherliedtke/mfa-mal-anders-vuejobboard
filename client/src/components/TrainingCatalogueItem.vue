    ...
    <div v-if="training._id" class="meta mb-3">
      ...
      >
        <svg
          ...
          height="14"
          fill="currentColor"
          class="bi bi-tag-fill mr-2"
          viewBox="0 0 16 16"
        >
          <path
            d="M2 1a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l4.586-4.586a1 1 0 0 0 0-1.414l-7-7A1 1 0 0 0 6.586 1H2zm4 3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"
          /></svg
        ><span>{{ training.eventType }}</span>
      </div>
      <div class="badge badge-secondary badge-pill mr-1">
        <svg
          ...
          height="14"
          fill="currentColor"
          class="bi bi-calendar2-fill mr-2"
          viewBox="0 0 16 16"
        >
          <path
        ...
        <span v-if="training.startAnytime">Jederzeit starten</span>
        <span v-else>Termine regelmäßig / auf Anfrage</span>
      </div>
      <div
      ...
      <div v-if="training.remote" class="badge badge-secondary badge-pill mr-1">
        <svg
          ...
          height="14"
          fill="currentColor"
          class="bi bi-laptop mr-2"
          viewBox="0 0 16 16"
        >
          <path
            d="M13.5 3a.5.5 0 0 1 .5.5V11H2V3.5a.5.5 0 0 1 .5-.5h11zm-11-1A1.5 1.5 0 0 0 1 3.5V12h14V3.5A1.5 1.5 0 0 0 13.5 2h-11zM0 12.5h16a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5z"
          /></svg
        ><span>Online / Fern</span>
      </div>
      <div
      ...
      >
        <svg
          ...
          height="14"
          fill="currentColor"
          class="bi bi-hourglass-split mr-2"
          viewBox="0 0 16 16"
        >
          <path
      ...
      <div v-if="training.cost" class="badge badge-secondary badge-pill mr-1">
        <svg
          ...
          height="14"
          fill="currentColor"
          class="bi bi-currency-euro mr-2"
          viewBox="0 0 16 16"
        >
          <path
      ...
      >
        <svg
          ...
          height="14"
          fill="currentColor"
          class="bi bi-mortarboard-fill mr-2"
          viewBox="0 0 16 16"
        >
          <path
