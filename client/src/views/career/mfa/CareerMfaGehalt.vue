    ...
    <div class="salary">
        ...
        <b-container class="py-3 py-lg-5">
            ...
            <p>
                ...
                Gehaltsniveau einschätzen zu können. Hier steigern vor allem
                abgeschlossene
            ...
            <p>
                Nach welchen Kriterien sich die Tätigkeitsgruppen aufteilen,
                zeigt dir die nachfolgende Übersicht.
            </p>
                    ...
                    >
                        <b-card-body>
                            <b-card-text>
                                <ul>
                                    <li>
                                        Berufseinsteiger nach abgeschlossener
                                        Ausbildung zur medizinischen
                                        Fachangestellten
                                    </li>
                                    <li>
                                        Du führst Tätigkeiten nach Anweisungen
                                        des Arztes oder einer erfahreneren
                                        Kollegin aus
                                    </li>
                                </ul>
                            </b-card-text>
                    ...
                    >
                        <b-card-body>
                            <b-card-text>
                                <ul>
                                    <li>
                                        Du kannst Tätigkeiten weitestgehend
                                        selbstständig ausführen
                                    </li>
                                    <li>
                                        Du hast mind. 40 Fortbildungsstunden
                                        gesammelt und weist vertiefte Kenntnisse
                                        und Fertigkeiten in einem Arbeitsbereich
                                        auf
                                    </li>
                                </ul>
                                <p>
                                    <em
                                        >Fortbildungsmaßnahmen sind zum
                                        Beispiel:</em
                                    >
                                </p>
                                <ul>
                    ...
                    >
                        <b-card-body>
                            <b-card-text>
                                <ul>
                                    <li>
                                        Du hast mindestens 80
                                        Fortbildungsstunden gesammelt und/oder
                                        weist entsprechende Berufserfahrung nach
                                    </li>
                                    <li>
                                        Du führst Tätigkeiten in der
                                        Durchführung der Ausbildung der
                    ...
                    >
                        <b-card-body>
                            <b-card-text>
                                <ul>
                                    <li>
                                        Du führst Tätigkeiten komplett
                                        selbstständige aus
                                    </li>
                                    <li>
                                        Du hast besonders vielseitige
                                        Fachkenntnisse die durch Aneignung
                                        zusätzlicher umfassender Fertigkeiten,
                                        Kenntnisse und Fähigkeiten in komplexen
                                        Arbeitsbereichen erworben
                                    </li>
                                    <li>
                                        Du hast mindestens 120
                                        Fortbildungsstunden gesammelt und/oder
                                        übernimmst Tätigkeiten in der
                                        systematischen Planung, Durchführung und
                    ...
                    >
                        <b-card-body>
                            <b-card-text>
                                <ul>
                                    <li>
                                        Du führst leitungsbezogenen Tätigkeiten
                                        aus
                                    </li>
                                    <li>
                                        Du kannst Fortbildungsmaßnahmen von
                                        insgesamt mindestens 360 Stunden und
                                        entsprechende Berufserfahrung vorweisen
                                    </li>
                                    <li>
                                        Hierbei sind eine Fortbildung von
                                        mindestens 120 Stunden und weitere
                                        Fortbildungseinheiten von mindestens 40
                                        Stunden innerhalb eines Zeitraums von 5
                                        Jahren zu erbringen. Dieser Zeitraum
                                        verlängert sich um die in Anspruch
                    ...
                    >
                        <b-card-body>
                            <b-card-text>
                                <ul>
                                    <li>
                                        Du führst leitungs- und führungsbezogene
                                        Tätigkeiten aus
                                    </li>
                                    <li>
                                        Du kannst Fortbildungsmaßnahmen von
                                        insgesamt mindestens 600 Stunden und
                                        entsprechende Berufserfahrung vorweisen
                                    </li>
                                </ul>
                                <p>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        Gesundheitswesen gemäß § 54 BBiG
                                    </li>
                                    <li>
                                        <b-link
                                            to="/karriere/fort-und-weiterbildungen"
                                            >Fachwirtin im Gesundheits- und
                                            Sozialwesen</b-link
                                        >
                                        gemäß § 53 BBiG
                                    </li>
            ...
            <p>
                Die Ärztekammer Baden-Württemberg hat zum Thema
                Gehaltstarifvertrag eine gute<a
            ...
            <p>
                <a
                    href="https://www.teramed.de/magazin/gehalt-medizinische-fachangestellte-2018-nach-tarifvertrag-oder-individuell-bezahlt-r/"
                    target="_blank"
                    rel="noopener"
                    >Blogartikel</a
                >
        ...
        data() {
            return {
                ...
                breadcrumbs: [
                    ...
                    { text: "MFA - Gehalt", to: "/karriere/mfa/gehalt" }
                ],
                snippet: [
                    {
