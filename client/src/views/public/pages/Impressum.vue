<template>
    <div class="impressum">
        ...
        <b-container class="py-5">
            ...
            <p>Kristin Maurach<br />Schreiberhauer Str. 9<br />10317 Berlin</p>
            <h2>Kontakt</h2>
            <p>
                E-Mail:&nbsp;<a href="mailto:kontakt@mfa-mal-anders.de"
                    >kontakt@mfa-mal-anders.de</a
                >
            </p>
            <h2>
        ...
        <Head :title="title" desc="This is the meta of Impressum..." img="" />
    </div>
</template>
