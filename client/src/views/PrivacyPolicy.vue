    ...
    <div class="container py-3 py-lg-5">
      <div>
        ...
        <p>
          ...
          6<br />49808 Lingen (Ems)
        </p>

        <p>
          E-Mail Adresse: kontakt(at)mfa-mal-anders.de<br />Link zum
          Impressum:&nbsp;<a href="/impressum"
            >https://www.mfa-mal-anders/impressum/</a
          >
        </p>
        ...
        <p>
          ...
          Kontaktdaten (z.B., E-Mail, Telefonnummern).<br />– Inhaltsdaten
          (z.B., Texteingaben, Fotografien, Videos).<br />– Nutzungsdaten (z.B.,
          besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten).<br />–
          Meta-/Kommunikationsdaten (z.B., Geräte-Informationen, IP-Adressen).
        </p>

        <p>
          – Angaben aus dem Bewerbungsformular (z.B. Gehaltswunsch, Motivation,
        ...
        <p>
          ...
          Nutzern.<br />– Sicherheitsmaßnahmen.<br />–
        ...
        <p>
          ...
          wird, Folgendes:<br />Die Rechtsgrundlage für die Einholung von
          Einwilligungen ist Art. 6 Abs. 1 lit. a und Art. 7 DSGVO;<br />Die
          ...
          Anfragen ist Art. 6 Abs. 1 lit. b DSGVO;<br />Die Rechtsgrundlage für
          die Verarbeitung zur Erfüllung unserer rechtlichen Verpflichtungen ist
          Art. 6 Abs. 1 lit. c DSGVO;<br />Für den Fall, dass lebenswichtige
          ...
          dient Art. 6 Abs. 1 lit. d DSGVO als Rechtsgrundlage.<br />Die
          Rechtsgrundlage für die erforderliche Verarbeitung zur Wahrnehmung
          einer Aufgabe, die im öffentlichen Interesse liegt oder in Ausübung
          öffentlicher Gewalt erfolgt, die dem Verantwortlichen übertragen wurde
          ist Art. 6 Abs. 1 lit. e DSGVO.<br />Die Rechtsgrundlage für die
          Verarbeitung zur Wahrung unserer berechtigten Interessen ist Art. 6
          Abs. 1 lit. f DSGVO.<br />Die Verarbeitung von Daten zu anderen
          Zwecken als denen, zu denen sie erhoben wurden, bestimmt sich nach den
          Vorgaben des Art 6 Abs. 4 DSGVO.<br />Die Verarbeitung von besonderen
        ...
        <p>
          ...
          internen Datenschutzvorschriften verarbeiten (Art. 44 bis 49
          DSGVO,&nbsp;<a
        ...
        <h3>Verarbeitung personenbezogener Daten für die Zahlungsabwicklung</h3>

        <p>
          Für die Bearbeitung Ihres Auftrages arbeiten wir mit den folgenden
          Dienstleistern zusammen, die uns ganz oder teilweise bei der
          Abwicklung der abgeschlossenen Verträge unterstützen. Bestimmte
          personenbezogene Daten werden an diese Dienstleister gemäß den
          folgenden Informationen übermittelt.
        </p>

        <p>
          Soweit Zahlungsdienstleister in Anspruch genommen werden, weisen wir
          Sie im Folgenden ausdrücklich darauf hin. Rechtsgrundlage für die
          Übermittlung der Daten ist Art. 6 Abs. 1 Buchstabe b D. Eine
          Weitergabe Ihrer Zahlungsdaten an das mit der Lieferung beauftragte
          Kreditinstitut erfolgt im Rahmen der Zahlungsabwicklung, soweit dies
          zur Zahlungsabwicklung erforderlich ist.Sofern Zahlungsdienstleister
          in Anspruch genommen werden, verpflichten wir uns ausdrücklich teilen
          Ihnen dies unten mit. Rechtsgrundlage für die Übermittlung der Daten
          ist Art. 6 Abs. 1 Buchstabe b GDPR.
        </p>

        <h4>Stripe</h4>

        <p>
          Wenn Sie eine Stripe-Zahlungsmethode wählen, wird die Zahlung durch
          den Zahlungsdienstleister Stripe Payments Europe Ltd, Block 4,
          Harcourt Centre, Harcourt Road, Dublin 2, Irland, abgewickelt, an den
          wir Ihre während des Bestellvorgangs gemachten Angaben zusammen mit
          den Informationen zu Ihrer Bestellung (Name, Adresse, Kontonummer,
          Bankleitzahl, ggf. Bankleitzahl, Kreditkartennummer, Rechnungsbetrag,
          Währung und Transaktionsnummer) gemäß Art. 6 Absatz 1 Buchstabe b
          GDPR. Eine Weitergabe Ihrer Daten erfolgt nur zum Zwecke der
          Zahlungsabwicklung mit dem Zahlungsdienstleister Stripe Payments
          Europe Ltd. und nur im notwendigen Umfang. Für weitere Informationen
          über die Datenschutzpolitik von Stripe besuchen Sie bitte:&nbsp;<a
        ...
        <h3>
          Verarbeitung personenbezogener Daten für Bewerberinnen und Bewerber
        </h3>

        <p><strong>Welche Daten verarbeiten wir?</strong></p>

        <p>
          Wenn Sie sich bei MFA mal anders bewerben, werden grundsätzlich nur
          solche Daten verarbeitet, die Sie uns im Rahmen der Bewerbung zur
          Verfügung gestellt haben. In der Regel verarbeiten wir so Ihre
          Kontaktdaten (Name, Vorname, E-Mail-Adresse) und persönliche
          Informationen, die sich aus dem Anschreiben und dem Lebenslauf
          (Bewerbungsdaten) ergeben.
        </p>
        ...
        <p>
          Es besteht keine gesetzliche oder vertragliche Pflicht zur
          Bereitstellung von Daten. Im Rahmen Ihrer Bewerbung sollen Sie nur
          diejenigen personenbezogenen Daten bereitstellen, die für die Aufnahme
          und Durchführung der Bewerbung erforderlich sind. Ohne diese Daten
          werden wir jedoch Ihre Aufnahme in den Bewerbungsprozess ablehnen
          müssen.
        </p>

        <p>
          <strong
            >Für welchen Zweck verarbeiten wir Ihre personenbezogenen
            Daten?</strong
          >
        </p>

        <p>
          Wir verarbeiten Ihre Daten, um Ihre Eignung für die ausgeschriebene
          Stelle oder ggf. eine andere offene Position in unserem Unternehmen zu
          prüfen und um das Bewerbungsverfahren durchzuführen.
        </p>

        <p>
          <strong
            >Auf welcher Rechtsgrundlage stützen wir die Verarbeitung Ihrer
            personenbezogenen Daten?</strong
          >
        </p>

        <p>
          Die Rechtsgrundlage für die Verarbeitung Ihrer personenbezogenen Daten
          in diesem Bewerbungsverfahren ist Art. 88 DSGVO i.V.m. § 26 BDSG.
          Danach ist die Verarbeitung der Daten zulässig, die im Zusammenhang
          mit der Entscheidung über die Begründung eines
          Beschäftigungsverhältnisses erforderlich sind.
        </p>

        <p>
          Insbesondere Daten, die wir über das Bewerbungsverfahren hinausgehend
          verarbeiten, werden i.d.R. aufgrund des Art. 6 Abs. 1 S. 1 lit. c)
          DSGVO verarbeitet. Dies ist der Fall, wenn wir gesetzlich verpflichtet
          sind, Ihre Daten z.B. aus steuerrechtlichen Gründen weiter zu
          verarbeiten (z.B. Erstattung der Anreisekosten).
        </p>

        <p><strong>An welche Empfänger geben wir die Daten weiter?</strong></p>

        <p>
          Ihre Bewerberdaten werden nach Eingang Ihrer Bewerbung von der
          Personalabteilung und den entsprechenden Führungskräften gesichtet.
          Geeignete Bewerbungen werden dann intern an die
          Abteilungsverantwortlichen für die jeweils offene Position
          weitergeleitet. Im Unternehmen haben grundsätzlich nur die Personen
        ...
        <p>
          Daten aus Ihrer Bewerbung werden im Falle einer Absage spätestens nach
          einer Frist von 6 Monaten gelöscht. Selbstverständlich können Sie Ihre
          Bewerbung auch zurückziehen und wir löschen Ihre personenbezogenen
          Daten unverzüglich, sofern der Löschung keine gesetzlichen
          Aufbewahrungsfristen entgegenstehen.
        </p>

        <p>
          Bei einer Einwilligung zu längerfristiger Speicherung in unserem
          Bewerberpool gilt die mit Ihnen vereinbarte Speicherdauer. Diese
          beträgt in der Regel 2 Jahre.
        </p>

        <p>
          Bei einer Einstellung speichern wir Ihre Bewerbungsunterlagen und
          führen diese in die Personalakte über.
        </p>

        <p><strong>Werden meine Daten an ein Drittland übermittelt?</strong></p>

        <p>
          Eine Übermittlung Ihrer Bewerberdaten in ein Drittland findet
          grundsätzlich nicht statt. Ausnahmsweise kann dies bei bestimmten
          Programmen der Fall sein, wenn wir diese zur Bewerberverwaltung
          benutzen.
        </p>
        ...
        <p>
          Ihre Rechte ergeben sich aus den Art. 15 ff. DSGVO. Unter anderem
          haben Sie:
        </p>

        <ul>
          <li>ein Auskunftsrecht nach Art. 15 DSGVO</li>
          <li>
            ein Recht auf Berichtigung Ihrer personenbezogenen Daten nach Art.
            16 DSGVO
          </li>
          <li>ein Recht auf Löschung Art. 17 DSGVO</li>
          <li>
            ein Recht auf Einschränkung der Verarbeitung nach Art. 18 DSGVO
          </li>
          <li>sowie ein Recht auf Datenübertragbarkeit nach Art. 20 DSGVO</li>
        </ul>

        <p>
          Zusätzlich können Sie in dem Fall, dass die Verarbeitung einem
          berechtigtem Interesse nach Art. 6 Abs. 1 S. 1 lit. f) der
          Verarbeitung nach Art. 21 DSGVO widersprechen. Jedoch werden die
          personenbezogenen Daten nur dann nicht mehr verarbeitet, wenn wir
          keine schutzwürdigen Gründe für die Verarbeitung nachweisen können,
          die Ihre Rechts- und Freiheitsinteressen überwiegen. Unbeschadet
          dessen bleibt Ihnen stets die Möglichkeit sich bei der zuständigen
          Datenschutzaufsichtsbehörde zu beschweren (Art. 77 DSGVO i.V.m. § 19
          BDSG) oder einen gerichtlichen Rechtsbehelf einzulegen (Art. 78
          DSGVO).
        </p>
        ...
        <p>
          ...
          Kommentarabonnements jederzeit abbestellen. Die Bestätigungsemail wird
          Hinweise zu den Widerrufsmöglichkeiten enthalten. Für die Zwecke des
        ...
        <p>
          ...
          und wirtschaftlichem Betrieb unseres Onlineangebotes) gem. Art. 6 Abs.
          1 lit. f DSGVO branchenübliche Trackingmaßnahmen ein, soweit diese für
          den Betrieb des Affiliatesystems erforderlich sind. Nachfolgend klären
          wir die Nutzer über die technischen Hintergründe auf.
        </p>
        ...
        <p>
          ...
          Links oder anderweitig, z.B. in einem Cookie, gesetzt werden können.
        ...
        <p>
          ...
          Nur so kann das Partnerunternehmen uns mitteilen, ob derjenige Nutzer
          das Angebot wahrgenommen hat und wir z.B. den Bonus auszahlen können.
        </p>
        ...
        <p>
          ...
          am wirtschaftlichem Betrieb unseres Onlineangebotes im Sinne des Art.
          6 Abs. 1 lit. f. DSGVO) Teilnehmer des Partnerprogramms von Amazon EU,
          ...
          Amazon.de Werbekostenerstattung verdient werden kann (sog.
          Affiliate-System). D.h. als Amazon-Partner verdienen wir an
        ...
        <p>
          ...
          den Partnerlink auf dieser Website geklickt und anschließend ein
        ...
        <p>
          ...
          Inc. oder eines seiner verbundenen Unternehmen.
        </p>
        ...
        <p>
          ...
          „MailGun“, einer Newsletterversandplattform des US-Anbieters Mailgun
          Technologies, Inc., 112 E Pecan St. #1135 San Antonio, TX 78205, USA.
          Die Datenschutzbestimmungen des Versanddienstleisters können Sie hier
          einsehen:&nbsp;<a
            href="https://mailchimp.com/legal/privacy/"
            rel="noreferrer noopener"
            target="_blank"
            >https://www.mailgun.com/gdpr/</a
          >. Mailgun Technologies, Inc. ist unter dem Privacy-Shield-Abkommen
          zertifiziert und bietet hierdurch eine Garantie, das europäisches
          Datenschutzniveau einzuhalten (<a
        ...
        <p>
          ...
          zu den Google-Diensten verwiesen. Nutzungsrichtlinien:&nbsp;<a
        ...
        <p>
          Wir setzen Google Analytics nur mit aktivierter IP-Anonymisierung und
          ohne Cookies ein. Das bedeutet, die IP-Adresse der Nutzer wird von
        ...
        <p>
          ...
          personenbezogenen Daten der Nutzer auf Grundlage unserer berechtigten
        ...
        <p>
          ...
          hierdurch zusichert, das europäische Datenschutzrecht einzuhalten (<a
        ...
        <p>
          ...
          Square, Grand Canal Harbour, Dublin 2, Irland) auf Grundlage
          einer&nbsp;<a
        ...
        <p>
          ...
          Street, Dublin 4, Irland) – Datenschutzerklärung:&nbsp;<a
            href="https://policies.google.com/privacy"
            rel="noreferrer noopener"
            target="_blank"
            >https://policies.google.com/privacy</a
        ...
        <p>
          ...
          CA 94103, USA) – Datenschutzerklärung:&nbsp;<a
        ...
        <p>
          Wir binden die Landkarten des Dienstes “HERE Maps” des Anbieters HERE
          Global B.V. of Kennedyplein 222 -226, 5611 ZT Eindhoven, Niederlande,
          ...
          verarbeitet werden. Datenschutzerklärung:&nbsp;<a
            ...
            target="_blank"
            rel="noreferrer noopener"
            >https://legal.here.com/de-de/privacy/policy</a
          >,
        </p>
        ...
        <p>
          ...
          Canal Harbour, Dublin 2, Irland betrieben wird („Facebook“).<br />Hierzu
        ...
        <p>
          ...
          können diese den Datenschutzhinweisen von Facebook entnehmen:&nbsp;<a
            href="https://www.facebook.com/about/privacy/"
            rel="noreferrer noopener"
            target="_blank"
            >https://www.facebook.com/about/privacy/</a
        ...
        <p>
          ...
          innerhalb von Twitter teilen können.<br />Sofern die Nutzer Mitglieder
          der Plattform Twitter sind, kann Twitter den Aufruf der o.g. Inhalte
          und Funktionen den dortigen Profilen der Nutzer zuordnen. Twitter ist
        ...
        <p>
          ...
          z.B. Inhalte wie Bilder, Videos oder Texte und Schaltflächen gehören,
          mit denen Nutzer Inhalte dieses Onlineangebotes innerhalb von
          Pinterest teilen können. Sofern die Nutzer Mitglieder der Plattform
          Pinterest sind, kann Pinterest den Aufruf der o.g. Inhalte und
          Funktionen den dortigen Profilen der Nutzer zuordnen.
          Datenschutzerklärung von Pinterest:&nbsp;<a
            href="https://about.pinterest.com/de/privacy-policy"
            rel="noreferrer noopener"
            target="_blank"
            >https://about.pinterest.com/de/privacy-policy</a
